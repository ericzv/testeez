...
const ATTACK_EFFECTS = {
    ...
    "ataque_basico_front": {
        type: "combined",
        duration: 725, // OTIMIZADO: 1450ms → 725ms (-50%)
        particles: {
            count: 32,
    ...
    "sobrecarga_energia_front": {
        type: "combined",
        duration: 750, // OTIMIZADO: 1500ms → 750ms (-50%)
        particles: {
            count: 45,
    ...
    "raio_elemental_front": {
        type: "combined",
        duration: 700, // OTIMIZADO: 1400ms → 700ms (-50%)
        particles: {
            count: 42,
    ...
    "devastacao_primordial_front": {
        type: "combined",
        duration: 1000, // OTIMIZADO: 2000ms → 1000ms (-50%)
        particles: {
            count: 120,
    ...
    "apunhalada_traiceira_front": {
        type: "combined",
        duration: 675, // OTIMIZADO: 1350ms → 675ms (-50%)
        particles: {
            count: 32,
