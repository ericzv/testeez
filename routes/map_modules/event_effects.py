...
def apply_single_effect(player, effect: dict) -> dict:
    ...
    if effect_type == 'gain_gold':
        ...
        if random.random() < 0.5:
            ...
            return {
                ...
                'icon': 'events/choices/choice-accept.png',
                'positive': True
            }
        else:
            # Perdeu - perde tudo
            ...
            return {
                ...
                'icon': 'events/choices/choice-curse.png',
                'positive': False
            }
    ...
    # ===== EFEITOS DE HP =====
        ...
        return {
            ...
            'value': healed,
            'message': f'+{healed} HP',
            'icon': 'events/choices/choice-heal.png',
            'positive': True
        }
    ...
    # ===== EFEITOS DE DANO/SKILLS =====
        ...
        return {
            ...
            'icon': 'events/choices/choice-shield.png',
            'positive': True
        }
        ...
        if selected_outcome['effects']:
            ...
            if sub_results:
                return {
                    ...
                    'icon': 'events/choices/choice-inspect.png',
    ...
    # ===== EFEITOS DE COMBATE/BUFFS TEMPORÁRIOS =====
        ...
        return {
            ...
            'icon': 'events/choices/choice-gold.png',
            'positive': True
        }
        ...
        return {
            ...
            'icon': 'events/choices/choice-rest.png',
            'positive': True
        }
    ...
    # ===== EFEITOS DE COMBATE =====
        ...
        return {
            ...
            'icon': 'events/choices/choice-attack.png',
            'positive': False,
...
def _award_random_relic(player, rarity: str) -> dict:
    ...
    if not available:
        return {
            ...
            'icon': 'events/choices/choice-refuse.png',
            'positive': False
        }
